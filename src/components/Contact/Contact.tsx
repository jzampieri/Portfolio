      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="flex flex-col justify-between md:items-end">
            ...
            >
              <span className="block relative text-xl transition-transform duration-300 group-hover:-translate-y-full">
                {translations[lang].resume}
              </span>
              <span className="block absolute left-0 top-full text-xl transition-transform duration-300 group-hover:-translate-y-full text-purple-400">
                {translations[lang].resume}
              </span>
            </a>
          </div>
